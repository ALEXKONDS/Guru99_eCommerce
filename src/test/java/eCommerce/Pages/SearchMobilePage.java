...
public class SearchMobilePage {
	...
	@FindBy(xpath = "(//a[@class='link-compare'][normalize-space()='Add to Compare'])[2]") WebElement text_AddToCompare_SonyXperia;
	@FindBy(xpath = "(//a[@class='link-compare'][normalize-space()='Add to Compare'])[3]") WebElement text_AddToCompare_AppleiPhone;
	...
	public void click_AddToCompare_SonyXperia() {
		text_AddToCompare_SonyXperia.click();
	}
	
	public void click_AddToCompare_AppleiPhone() {
		text_AddToCompare_AppleiPhone.click();
	}
}
